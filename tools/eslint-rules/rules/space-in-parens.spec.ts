...
import { rule, RULE_NAME } from './space-in-parens'
...
ruleTester.run(RULE_NAME, rule, {
  valid: [
    ...
    // ! Bang
    { code: "foo( !isBanger )", options: ["always", { exceptions: [] }] },
    { code: "foo(!isBanger )", options: ["always", { exceptions: ["!"] }] },
    { code: "foo(!isBanger)", options: ["never", { exceptions: [] }] },
    { code: "foo( ! isBanger)", options: ["never", { exceptions: ["!"] }] },
  ],
  invalid: [
    ...
    },
    {
      ...
      options: ['never'],
      errors: [{
        messageId: 'rejectedClosingSpace', line: 3, column: 4,
      }],
    },
    {
      code: 'foo\n(bar\n)\n',
      ...
      options: ['always'],
      errors: [{
        messageId: 'missingOpeningSpace', line: 2, column: 1,
      }],
    },
    {
      code: 'foo( bar)',
    ...
    },
    {
      ...
      parserOptions: { ecmaVersion: 6 },
      errors: [{
        messageId: 'missingOpeningSpace', line: 1, column: 19,
      }],
    },
    ...
    },
    {
      ...
      errors: [{
        ...
        messageId: 'rejectedClosingSpace', line: 1, column: 15,
      }],
    },
  ],
})
